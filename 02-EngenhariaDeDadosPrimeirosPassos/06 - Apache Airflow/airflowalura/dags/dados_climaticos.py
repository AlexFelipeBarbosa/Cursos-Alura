...
with DAG(
  ...
  tarefa_1 = BashOperator(
   task_id = 'cria_pasta',
   bash_command='mkdir -p "/home/alex/Documentos/airflowalura/semana={{data_interval_end.strftime("%Y-%m-%d")}}/"'    
  ) 
  ...
  def extrai_dados(data_interval_end):
    ...
    file_path = f'/home/alex/Documentos/airflowalura/semana={data_interval_end}/'
