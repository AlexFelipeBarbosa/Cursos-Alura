...
# cp -r /home/alex/Documentos/projeto_requests /mnt/c/alex/github
...
alex_rep = DadosRepositorios('alexfelipebarbosa')  
ling_mais_usadas_alex = alex_rep.cria_df_linguagens()
#print(ling_mais_usadas_alex)
...
ling_mais_usadas_alex.to_csv('Dados/linguagens_alex.csv')